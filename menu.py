...
def draw_all():
    ...
    boton_quickplay_presionado = pygame.image.load(os.path.join("E:\Github desklol\Guitar-Huergo\Assets\Menu", "QUICK PLAY PRESIONADO V2.png")).convert_alpha()
    screen.blit(background, (0,0))
    screen.blit(logo, (500, 0))
    screen.blit(boton_quickplay, (0,25))
